...
description: Template messages allow you to define reusable message structures with placeholders, which are then populated dynamically using data provided at runtime.
---
