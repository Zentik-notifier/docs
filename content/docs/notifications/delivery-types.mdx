...
description: Understanding how `NotificationDeliveryType` influences user experience and platform behavior.
---
...
See also: [Delivery Strategies](./delivery-strategies) — How Zentik handles payload encryption and APNs size limits (ENCRYPTED, UNENCRYPTED, SELF_DOWNLOAD)
