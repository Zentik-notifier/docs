---
title: Overview
description: Zentik - Notifications that make the most of iOS
---
...
Explore the full API via Swagger UI: [notifier-api.zentik.app/api/docs](https://notifier-api.zentik.app/api/docs)
...
## Next Steps
1. [Notification Flows](./notification-flows) – How notifications are delivered
2. [Retention Policy](./retention-policy) – Data lifecycle and cleanup
3. [Rate Limiting](./rate-limiting) – API rate limits and configuration
4. Start sending messages: [Notifications](/docs/notifications)
5. Deploy or try locally: [Self-hosted Installation](/docs/self-hosted/installation)
